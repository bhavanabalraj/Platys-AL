...
def train_without_AL(X, Y, M, model):
...
# train_without_AL(X, Y, M, model_full_supervised)
...
def stratify_samples(y_unlabelled_AL, sample_indices, threshold):
    ...
    rest_of_indices = set(range(0, len(sample_indices))) - stratified_sample_indicies

    return list(stratified_sample_indicies), list(rest_of_indices)
